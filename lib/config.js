...
const SHARED_CONFIG = {
  ...
  SHOP_CATALOG: [
    ...
    { itemId: "door_simple", price: 50 }, // Example: Doors can be bought?
...
const SERVER_CONFIG = {
  ...
  // DEFAULT_SAVE_FILE: 'room_state.json', // Replaced by directory setting
  EMOTE_DURATION_SERVER: 3000, // Default duration if not specified in emote def

  // --- NEW: Multi-Room Settings ---
  DEFAULT_SAVE_DIR: "room_saves", // Directory to store individual room save files
