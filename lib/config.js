...
const SHARED_CONFIG = {
  ...
  TILE_SPRITE_SHEET_URL: "/img/sprites/furniture_atlas.png", // Assumes tiles are on the same sheet
  TILE_SPRITE_DEFINITIONS: {
    // *** IMPORTANT: REPLACE placeholder x, y, w, h with ACTUAL coordinates from your atlas! ***
    0: {
      // Default Floor
      x: 64,
      y: 0,
      w: 64,
      h: 128, // EXAMPLE PLACEHOLDER! Find your floor tile in the atlas.
      anchor: { x: 64, y: 0 }, // Usually center of the tile sprite (width/2, height/2)
    },
    1: {
      // Wall - Replace with your wall base sprite coords, or remove if drawing walls procedurally
      x: 64,
      y: 0,
      w: 64,
      h: 128, // EXAMPLE PLACEHOLDER!
      anchor: { x: 64, y: 0 },
      // useSprite: false // Add this if you want ClientTile to draw walls as colored diamonds instead of using a sprite
    },
    2: {
      // Alt Floor - Replace if you have an alt floor sprite
      x: 64,
      y: 0,
      w: 64,
      h: 128, // EXAMPLE PLACEHOLDER!
    ...
    X: {
      // Hole - Replace if you have a hole sprite
      x: 64,
      y: 0,
      w: 64,
      h: 128, // EXAMPLE PLACEHOLDER!
      anchor: { x: 64, y: 0 },
      // useSprite: false // Add this if you want ClientTile to draw holes as colored diamonds instead of using a sprite
    },
    // --- Fallback/Default ---
    default: {
      // Used if a specific layoutType (like 0, 1, 2, X) isn't found above
      x: 64,
      y: 0,
      w: 64,
      h: 128, // EXAMPLE: Same as Floor 0 placeholder
      anchor: { x: 64, y: 0 },
    },
  },
